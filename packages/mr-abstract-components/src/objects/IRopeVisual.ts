...
import { IVisualConnector } from '../canvas/IVisualConnector.js';
import { Vector2 } from '@my-graphics/math';
import { IController } from '../IController.js';
import { IControllerConfiguration } from '../IController.js';

export interface IRopeController extends IController {
